...
enum {
    ...
    ROBOT_WALK_RUN_FORWARD_10MM,
    ROBOT_WALK_RUN_FORWARD_3MM,
    MOTION_TURN_LEFT_4DEG,      // 4.1도
    MOTION_TURN_LEFT_9DEG,      // 9도
    MOTION_TURN_LEFT_30DEG,     // 30도
    MOTION_TURN_RIGHT_4DEG,     // 4.1도
    MOTION_TURN_RIGHT_9DEG,     // 9도
    MOTION_TURN_RIGHT_30DEG     // 30도
};
