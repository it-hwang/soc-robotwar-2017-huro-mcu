...
OBJS = main.o terminal.o uart_api.o robot_protocol.o graphic_api.o graphic_interface.o matrix.o lut.o color.o obstacle_manager.o object_detection.o processor.o
